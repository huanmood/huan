...
# 更多按钮
moreButton = (
By.XPATH, '//android.widget.TextView[@resource-id="com.nelko.printer:id/view_menu_title" and @text="更多"]')
# 确定
...
'''登录页面'''
# 邮箱
email_loc = (By.ID, 'com.nelko.printer:id/edit_email')
# 密码
pwd_loc = (By.ID, 'com.nelko.printer:id/edit_password')
# 登录
login_button_loc = (By.ID, 'com.nelko.printer:id/sign_in')
# 勾选
ticked_button_loc = (By.ID, 'com.nelko.printer:id/checkBox_agreement')

uer_email_login = (By.XPATH, '//android.widget.TextView[@text="使用Email登录"]')
# 登录成功后的菜单首页
login_success_loc = (By.XPATH, '//android.widget.TextView[@text="首页"]')
