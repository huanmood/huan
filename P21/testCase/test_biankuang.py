...
class classBiankuang(function, unittest.TestCase):
    ...
    def test_02_lock(self):
        lock = ['XPATH', '//android.widget.LinearLayout[@resource-id="com.nelko.printer:id/act_edit_action_lock_btn"]/android.widget.ImageView']
